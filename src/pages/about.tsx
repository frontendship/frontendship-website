    ...
    <div>
      <Hero>
        ...
        <Hero.Subtitle>
          ...
          meaningful connections between builders and customers. Join our remote
          ream!
        </Hero.Subtitle>
      </Hero>

      <section className="mx-auto grid max-w-7xl md:grid-cols-3 sm:grid-cols-2 sm:gap-x-4 lg:grid-cols-4 md:gap-x-8 md:gap-y-16 gap-y-10 md:px-8 px-4 pt-12 pb-24">
        <TeamCard>
          <TeamCard.Image
            alt="asda"
